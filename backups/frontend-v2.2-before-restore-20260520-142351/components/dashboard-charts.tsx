      ...
      {monthlyChart && monthlyChart.length > 0 && (
        <Card className="rounded-2xl border-border bg-card py-0 shadow-sm">
          <CardContent className="p-4">
            <h3 className="mb-4 text-base font-bold text-foreground">Pendapatan Bulanan</h3>
            <div className="h-48 min-h-48 min-w-0" role="img" aria-label="Grafik pendapatan bulanan">
        ...
        <Card className="rounded-2xl border-border bg-card py-0 shadow-sm">
          <CardContent className="p-4">
            ...
            {(() => {
              ...
              return (
                <div className="flex min-w-0 items-center gap-4" role="img" aria-label={isAdmin ? "Grafik setoran per driver" : "Grafik berdasarkan tipe order"}>
                  <div className="h-36 min-h-36 w-36 min-w-36">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          data={pieData}
