...
function createDepositRecapPdf(
  ...
  const drawProfitSummary = () => {
    ...
    drawMiniMetric(1, "Wajib Setor", `Rp ${formatRupiah(profit.companyShare)}`, [0.94, 0.98, 0.95], [0.02, 0.42, 0.22])
    ...
    text(margin + 14, 296, `Laba Bersih = Rp ${formatRupiah(profit.companyShare)} - Rp ${formatRupiah(profit.serviceCost)} = Rp ${formatRupiah(profit.netProfit)}`, { size: 8.8, fill: [0.28, 0.34, 0.31] })
    ...
    text(completionRight, 306, `Masuk Rp ${formatRupiah(profit.paid)} dari Rp ${formatRupiah(profit.companyShare)}`, { size: 7.8, fill: [0.38, 0.42, 0.4], align: "right" })
  }
