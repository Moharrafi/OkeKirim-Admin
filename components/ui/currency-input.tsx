...
function CurrencyInput({
  ...
  return (
    <div className="flex flex-col gap-1">
      <div
        className={cn(
          'border-input dark:border-foreground/15 dark:bg-input/30 dark:hover:border-foreground/25 relative flex w-full items-center rounded-xl border shadow-xs transition-[color,box-shadow] outline-none',
          'h-9',
